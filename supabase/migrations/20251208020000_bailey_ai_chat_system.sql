...
DROP POLICY IF EXISTS "Service role has full access to conversations" ON public.chat_conversations;
...
DROP POLICY IF EXISTS "Anyone can view active knowledge items" ON public.bailey_knowledge_base;
CREATE POLICY "Anyone can view active knowledge items"
    ON public.bailey_knowledge_base FOR SELECT
    USING (is_active = TRUE);

DROP POLICY IF EXISTS "Only admins can modify knowledge base" ON public.bailey_knowledge_base;
...
DROP POLICY IF EXISTS "Service role has full access to knowledge base" ON public.bailey_knowledge_base;
...
DROP POLICY IF EXISTS "Only admins can view analytics" ON public.bailey_analytics;
...
DROP POLICY IF EXISTS "Anyone can insert analytics" ON public.bailey_analytics;
CREATE POLICY "Anyone can insert analytics"
    ON public.bailey_analytics FOR INSERT
    WITH CHECK (TRUE);

DROP POLICY IF EXISTS "Service role has full access to analytics" ON public.bailey_analytics;
...
DROP POLICY IF EXISTS "Users can view their own preferences" ON public.chat_user_preferences;
CREATE POLICY "Users can view their own preferences"
    ON public.chat_user_preferences FOR SELECT
    USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own preferences" ON public.chat_user_preferences;
CREATE POLICY "Users can update their own preferences"
    ON public.chat_user_preferences FOR UPDATE
    USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Anyone can insert preferences" ON public.chat_user_preferences;
CREATE POLICY "Anyone can insert preferences"
    ON public.chat_user_preferences FOR INSERT
    WITH CHECK (TRUE);

DROP POLICY IF EXISTS "Service role has full access to preferences" ON public.chat_user_preferences;
