  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">By Hamilton Bailey Law</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+61882319448" className="hover:text-slate-900 dark:hover:text-white transition-colors">
                  (08) 8231 9448
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-300 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-600 dark:text-slate-500">
            © {new Date().getFullYear()} Hamilton Bailey Law. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-sm text-slate-600 dark:text-slate-500">
            <a
        ...
        {/* Disclaimer */}
        <div className="mt-6 p-4 bg-slate-200/50 dark:bg-slate-800/50 rounded-lg">
