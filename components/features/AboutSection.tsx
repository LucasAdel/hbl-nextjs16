      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-tiffany-lighter/20 to-white dark:from-tiffany/20 dark:to-slate-800">
              <Image
          ...
          <div className="lg:pt-4">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-normal text-gray-900 dark:text-white mb-8 tracking-tight">
            ...
            {/* First paragraph */}
            <p className="font-montserrat text-base text-gray-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            {/* Third paragraph */}
            <p className="font-montserrat text-base text-gray-700 dark:text-slate-300 leading-relaxed mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative pl-6 border-l-2 border-gray-200 dark:border-slate-700">
                <h3 className="font-serif text-xl text-tiffany-dark dark:text-tiffany-light mb-3 tracking-wide">
                  <span className="font-normal">O</span>
                  <span className="text-[0.85em]">UR</span>
                  {" "}
                ...
                <p className="font-montserrat text-sm text-gray-600 dark:text-slate-400 leading-relaxed">
