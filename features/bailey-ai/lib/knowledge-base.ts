...
export const KNOWLEDGE_BASE: KnowledgeItem[] = [
  ...
  // 1. Company Overview
  {
    ...
    content: "Hamilton Bailey is a boutique medical law firm specializing in commercial medical practice legal matters. We operate from two offices - our main office in Adelaide at Level 2/147 Pirie Street, and our international office in Dubai. We focus on providing pragmatic legal solutions that are both practical and timely for medical practitioners.",
    summary: "Boutique medical law firm with offices in Adelaide and Dubai, specializing in medical practice compliance and commercial law.",
    ...
    responseTemplate: "Hamilton Bailey is a boutique medical law firm specializing in commercial medical practice legal matters. We have offices in Adelaide (Level 2/147 Pirie Street) and Dubai, focusing on pragmatic legal solutions for healthcare professionals.\n\nOur expertise includes Tenant Doctor™ arrangements (we own this trademark), payroll tax compliance, medical practice structuring, and commercial property law.\n\nWould you like to know more about our specific services or book a consultation?",
  ...
  // 2. Principal Lawyer
  {
    ...
    content: "Lukasz Wyszynski is the principal lawyer at Hamilton Bailey Law Firm. He leads our specialized medical practice law team and has extensive experience in healthcare compliance, commercial law, and regulatory matters affecting medical practitioners.",
    summary: "Lukasz Wyszynski is the principal lawyer at Hamilton Bailey, specializing in medical practice law and healthcare compliance.",
  ...
  // 3. Tenant Doctor Trademark
  {
    ...
    content: "Hamilton Bailey owns the Tenant Doctor™ trademark and specializes in structuring independent practitioner arrangements that comply with payroll tax regulations. We help medical practices avoid significant payroll tax liabilities while maintaining operational efficiency.",
    summary: "We own the Tenant Doctor™ trademark and specialize in compliant independent practitioner arrangements.",
    ...
    responseTemplate: "Hamilton Bailey is the exclusive owner of the Tenant Doctor™ trademark in Australia. We specialize in structuring these arrangements to help medical practices:\n\n• Avoid payroll tax liabilities (which can exceed $250,000)\n• Maintain compliant independent contractor relationships\n• Navigate the 'triple regulatory threat' from ATO, State Revenue, and Fair Work\n• Structure operations for maximum efficiency\n\nOur expertise is based on recent case law including Thomas and Naaz [2022] and established precedents. Would you like to discuss how Tenant Doctor™ arrangements could benefit your practice?",
  ...
  // 4. Payroll Tax Compliance
  {
    ...
    title: "Payroll Tax Compliance for Medical Practices",
    content: "We specialize in payroll tax compliance for medical practices, including risk assessments, audit defense, and restructuring to avoid retrospective assessments that can exceed $250,000 excluding penalties.",
    summary: "Expert payroll tax compliance services to protect medical practices from significant financial liabilities.",
    keywords: ["payroll tax", "compliance", "audit", "state revenue", "tax liability", "medical practice", "assessment"],
    intentPatterns: ["payroll tax", "tax compliance", "state revenue", "tax audit", "tax liability"],
    responseTemplate: "Payroll tax compliance is critical for medical practices as liabilities can exceed $250,000, not including penalties and interest. We provide:\n\n• Risk assessments to identify potential exposures\n• Audit defense and State Revenue Office negotiations\n• Restructuring to achieve compliance\n• Preventive strategies based on recent cases like Thomas and Naaz [2022]\n\nMany practices are unaware they may have retrospective liabilities going back several years. Would you like a confidential assessment of your practice's payroll tax position?",
    requiresDisclaimer: true,
  ...
  // 14. Market Intelligence
  {
    ...
    summary: "Market intelligence showing increased demand for specialized healthcare legal services.",
  ...
  // 16. Service Entity Structures
  {
    ...
    content: "We specialize in designing compliant service entity structures that separate clinical operations from business services. This includes trust structures, corporate entities, partnership arrangements, and integrated compliance frameworks that satisfy all regulatory requirements.",
  ...
  // 17. Fair Work Compliance
  {
    ...
    summary: "Comprehensive Fair Work Act compliance to avoid employee misclassification and penalties.",
  ...
  // 18. Property and Leasing
  {
    ...
    content: "We provide specialized commercial property services for medical practices including lease negotiations, pathology collection room agreements, pharmacy arrangements, medical centre purchases, and property investment structuring. Medical leases have unique requirements.",
  ...
  // 19. Audit Defense
  {
    ...
    content: "We provide comprehensive audit defense services for State Revenue Office payroll tax audits, ATO reviews, Fair Work investigations, and Medicare audits. Our strategic approach includes early intervention, documentation review, negotiation strategies, and settlement optimization.",
    ...
    intentPatterns: ["audit defense", "audit notice", "investigation", "state revenue audit", "ato audit"],
  ...
  // 24. Success Stories
  {
    ...
    content: "Our clients have achieved significant outcomes including 75% reduction in proposed payroll tax assessments, successful Tenant Doctor™ implementations avoiding $250,000+ liabilities, Fair Work investigation dismissals, and optimized practice structures saving thousands annually.",
